...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    router.push("/admin"); // Redirecting to admin dashboard as per previous flow
  };
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="font-cormorant font-light text-[42px] leading-[1.1] text-[#F5F2EB] tracking-wide mb-3">
            Welcome <span className="italic text-[#F1A42F]">Back.</span>
          </h1>
        ...
        <div className="mt-8 text-center">
          <p className="font-inter text-xs text-white/40">
            ...
            <Link href="/signup" className="text-[#F1A42F] hover:text-white transition-colors underline-offset-4 hover:underline">
              Sign up
            </Link>
          </p>
        </div>
